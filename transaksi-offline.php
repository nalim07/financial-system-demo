            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item selected"> <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><i data-feather="credit-card" class="feather-icon"></i><span class="hide-menu">Tipe
                    ...
                    <ul aria-expanded="false" class="collapse  first-level base-level-line">
                        ...
                        <li class="sidebar-item active"><a href="javascript:void(0)" class="sidebar-link"><span class="hide-menu"> Offline
                                </span></a>
                        </li>
                    </ul>
                </li>
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Transaksi Offline</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            ...
                            <li class="breadcrumb-item text-muted active" aria-current="page">Offline</li>
                        </ol>
                    </nav>
                </div>
            </div>
